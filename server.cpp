...
byte server_change_program(char *p) {
  printf("Attempting to change a program\n");
  byte i;
...
byte server_enable_program(char *p) {
  //http://172.17.12.36/ep?pw=a6d82bced638de3def1e9bbb4983225c&pid=0&en=1
...
byte server_view_scripturl(char *p) {
  ...
  bfill.emit_p(PSTR("<form name=of action=cu method=get><table cellspacing=\"12\"><tr><td><b>JavaScript</b>:</td><td><input type=text size=40 maxlength=40 value=\"$E\" name=jsp></td></tr><tr><td>Default:</td><td>$S</td></tr><tr><td><b>Weather</b>:</td><td><input type=text size=40 maxlength=40 value=\"$E\" name=wsp></td></tr><tr><td>Default:</td><td>$S</td></tr><tr><td><b>Password</b>:</td><td><input type=password size=32 name=pw> <input type=submit></td></tr></table></form><script src=https://ui.OpenHome.com/js/hasher.js></script>"), ADDR_NVM_JAVASCRIPTURL, DEFAULT_JAVASCRIPT_URL, ADDR_NVM_WEATHERURL, DEFAULT_WEATHER_URL);
  return HTML_OK;
}
