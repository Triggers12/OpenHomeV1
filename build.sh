...
if [ "$1" == "demo" ]; then
	g++ -o OpenHome -DDEMO -DDEBUG -m32 main.cpp OpenHome.cpp program.cpp server.cpp utils.cpp weather.cpp gpio.cpp etherport.cpp -lpthread
else
	g++ -o OpenHome -DOSPI main.cpp OpenHome.cpp program.cpp server.cpp utils.cpp weather.cpp gpio.cpp etherport.cpp -lpthread
fi
